...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.buildaringfarm.org/mutations/" }
};
...
const sections = [
  {
    h2: "What are mutations in Build A Ring Farm?",
    h3: "Mutation meaning",
    body: [
      "Mutations are community reported rare crop effects that may change crop value or route priority. This page treats mutation names as research leads, not official Roblox data.",
      "The safest way to understand Build A Ring Farm mutations is to connect them with sprays, weather events, advanced crops, and tier-list logic without pretending the exact numbers are confirmed."
    ],
    list: ["Use mutations as rare-effect leads.", "Do not treat multipliers as official unless verified.", "Compare mutations with spray cost and event timing."]
  },
  {
    h2: "Can mutations stack?",
    h3: "Stacking is unverified",
    body: [
      "Stacking behavior is one of the highest-risk claims. Unless repeatable in-game tests prove it, mutation stacking should stay marked as needs verification.",
      "A useful test should record the crop, active event, spray used, before value, after value, and whether the result persists offline."
    ],
    list: ["Do not write guaranteed stacking.", "Do not copy stacking claims from competitors.", "Record screenshots before promoting a claim."]
  },
  {
    h2: "Mutations vs sprays and weather events",
    h3: "Two trigger paths",
    body: [
      "Community reports connect mutations to both sprays and weather events. Sprays may directly test an effect, while events may trigger similar effects through timing or chance.",
      "This creates a clear internal-link cluster: sprays explain item use, weather events explain event routes, advanced crops explain value context, and this page explains mutation intent."
    ],
    list: ["Wet connects to Rain and Wet Spray.", "Frozen connects to Blizzard and Frozen Spray.", "Rainbow connects to Galaxy and Rainbow Spray."]
  },
  {
    h2: "What still needs verification",
    h3: "Pending evidence",
    body: [
      "A strong mutation page needs exact effect behavior, confirmed values, stacking rules, offline behavior, and update history. Until then, this page should remain source-aware and conservative.",
      "If future tests confirm a mutation, record the source, date, test method, and result before changing its status."
    ],
    list: ["Exact mutation values.", "Stacking rules.", "Offline behavior.", "Event and spray interactions."]
  }
];
    ...
    <main className="page-main">
      <section className="page-hero compact-hero">
        <div className="hero-copy">
          <p className="eyebrow">Mutation effects guide</p>
          <h1>Build A Ring Farm Mutations Guide</h1>
          <p className="lede">Compare community reported Build A Ring Farm mutations, effect tiers, spray routes, weather event links, stacking questions, and source status without treating any mutation claim as official.</p>
          <div className="hero-actions"><Link className="primary-link" href="/sprays/">Read sprays</Link><Link className="secondary-link" href="/tier-list/">Read tier list</Link></div>
        </div>
