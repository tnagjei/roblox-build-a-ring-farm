...
const sections = [
  ...
  { h2: "Update 3 mutation leads", h3: "Honeycomb, Alien, and Farm are pending", body: ["The keyword report flags Honeycomb mutation, Alien mutation, and Farm mutation as new P1 opportunities. These terms can improve freshness, but they should not be treated as official mutation data without stronger evidence.", "Use these names as recheck leads. If future in-game tests confirm behavior, record the date, crop, trigger, before value, after value, and source before changing the status."], list: ["Honeycomb mutation: reported, pending verification.", "Alien mutation: reported, pending verification.", "Farm mutation: reported, pending verification."] },
...
const faq = [
  ...
  { q: "What is the strongest reported mutation?", a: "Multiple community sources usually place Rainbow highest, but this site does not treat that as official data." },
