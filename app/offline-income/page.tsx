...
export default function OfflineIncomePage() {
  return (
    <main className="page-main">
      <section className="page-hero compact-hero"><div className="hero-copy"><p className="eyebrow">Offline progress guide</p><h1>Build A Ring Farm Offline Income Guide</h1><p className="lede">Use this Build A Ring Farm offline income guide to separate offline earnings from unverified offline weather events, mutations, sprays, and rare-effect claims.</p><div className="hero-actions"><Link prefetch={false} className="primary-link" href="/money-farming/">Read money farming</Link><Link prefetch={false} className="secondary-link" href="/upgrades/">Read upgrades</Link></div></div><img className="hero-image" src={heroImage} alt="Build A Ring Farm Roblox thumbnail" /></section>
