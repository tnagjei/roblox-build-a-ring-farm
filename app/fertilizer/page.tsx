...
export default function FertilizerPage() {
  return (
    <main className="page-main">
      <section className="page-hero compact-hero"><div className="hero-copy"><p className="eyebrow">Fertilizer and growth guide</p><h1>Build A Ring Farm Fertilizer Guide</h1><p className="lede">Use this Build A Ring Farm fertilizer guide to compare community reported Strong Fertilizer, crop timing, sprays, upgrades, ROI, and source status without treating any fertilizer claim as official.</p><div className="hero-actions"><Link prefetch={false} className="primary-link" href="/gear-shop/">Read gear shop</Link><Link prefetch={false} className="secondary-link" href="/money-farming/">Read money farming</Link></div></div><img className="hero-image" src={heroImage} alt="Build A Ring Farm Roblox thumbnail" /></section>
