...
const pageTitle = "Build A Ring Farm Calculator | Crop Value Estimates";
const pageDescription = "Build A Ring Farm calculator for crop value estimates using player-entered values, manual high-value crop inputs, reported multipliers, and pending labels.";
...
const estimateRows = [
  ...
  { input: "High-value crop observed value", use: "Use Void Fruit, Garden Devourer, Dragonfruit, Passion Fruit, or Elder Dragonroot only after you record an observed value.", status: "Manual input only" },
...
const highValueCropRows = [
  { crop: "Void Fruit", inputRule: "Enter observed base value manually", sourceStatus: "Beebom reported, pending in-game check", resultType: "Estimated" },
  { crop: "Garden Devourer", inputRule: "Enter observed base value manually", sourceStatus: "Beebom reported, pending in-game check", resultType: "Estimated" },
  { crop: "Dragonfruit", inputRule: "Enter observed base value manually", sourceStatus: "Reported lead, value not confirmed here", resultType: "Estimated" },
  { crop: "Passion Fruit", inputRule: "Enter observed base value manually", sourceStatus: "Beebom reported, pending in-game check", resultType: "Estimated" },
  { crop: "Elder Dragonroot", inputRule: "Enter observed base value manually", sourceStatus: "Beebom reported, pending in-game check", resultType: "Estimated" }
];
...
const scenarioRows = [
  ...
  { route: "Void Fruit watchlist", estimate: "Manual crop value plus reported multipliers only", note: "Do not add a fixed Void Fruit value until in-game proof exists.", status: "Pending crop value" },
...
const sections = [
  { heading: "High-value crops use manual inputs only", subheading: "No default crop value shortcut", body: ["Void Fruit, Garden Devourer, Dragonfruit, Passion Fruit, and Elder Dragonroot are useful calculator search terms, but they should not become built-in crop value shortcuts without stronger evidence.", "Use the calculator only after you observe a base crop value in game. Then add plant count, reported or pending multipliers, and run count. The output is an estimate, not an official crop price."], list: ["Record the crop name and observed base value.", "Enter that value manually.", "Add only reported or pending multipliers with visible labels.", "Compare the estimate against the next actual sale before changing routes."] },
...
const relatedLinks = [
  { href: "/crops/", title: "Crops", description: "Check high-value crop lead status before entering a manual value." },
  { href: "/seeds/", title: "Seeds", description: "Review reported seed leads before converting them into crop checks." },
  ...
  { href: "/weather-events/", title: "Weather Events", description: "Keep event boosts and Starfall leads pending before calculation." },
...
const faq = [
  ...
  { q: "Can I use Void Fruit or Dragonfruit in the calculator?", a: "Yes, but only as manual crop value inputs. Void Fruit, Garden Devourer, Dragonfruit, Passion Fruit, and Elder Dragonroot are reported leads here, not built-in official values." },
...
export default function CalculatorPage() {
  return (
    <main className="page-main">
      <section className="page-hero compact-hero"><div className="hero-copy"><p className="eyebrow">Reported value estimator</p><h1>Build A Ring Farm Calculator</h1><p className="lede">Use this Build A Ring Farm calculator as a reported value estimator for plant count, observed crop value, manual high-value crop inputs, pending mutation presets, rings, fertilizer, pet or event notes, and repeated harvest planning without fixed official numbers.</p><div className="hero-actions"><Link prefetch={false} className="primary-link" href="/money-farming/">Plan money route</Link><Link prefetch={false} className="secondary-link" href="/crops/">Check crops</Link></div></div><img className="hero-image" src={heroImage} alt="Build A Ring Farm Roblox thumbnail" /></section>
