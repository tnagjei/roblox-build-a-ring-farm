...
const pageTitle = "Build A Ring Farm Seeds Guide | Seed Packs, Crop Value & Progression";
const pageDescription = "Build A Ring Farm seeds guide for Roblox players. Learn seed packs, crop unlocks, planting choices, code rewards, progression routes, and source-checked seed information.";
...
const sections = [
  {
    ...
    body: [
      ...
      "Because seed packs can affect what players grow next, seeds deserve a separate guide instead of being hidden inside a general crops page."
    ],
