...
const guideMenuSlugs = ["seeds", "upgrades", "gear-shop", "advanced-crops", "weather-events", "tier-list", "updates"];
        ...
        <div className="footer-clusters">
          ...
          <div className="footer-cluster">
            ...
            {gameConfig.robloxGroupUrl ? (
              <a href={gameConfig.robloxGroupUrl} target="_blank" rel="noopener noreferrer">
                {officialGroupLabel}
              </a>
            ) : null}
