...
export const gameConfig = {
  ...
  coreSlugs: ["", "codes", "updates", "beginners-guide", "crops", "seeds", "upgrades", "gear-shop", "sprays", "rainbow-spray", "mutations", "rainbow-mutation", "fertilizer", "strong-fertilizer", "offline-income", "farm-layout", "advanced-crops", "money-farming", "weather-events", "tier-list", "calculator", "rings", "update-3-status"],
  completedCoreSlugs: ["", "codes", "updates", "beginners-guide", "crops", "seeds", "upgrades", "gear-shop", "sprays", "rainbow-spray", "mutations", "rainbow-mutation", "fertilizer", "strong-fertilizer", "offline-income", "farm-layout", "advanced-crops", "money-farming", "weather-events", "tier-list", "calculator", "rings", "update-3-status"],
